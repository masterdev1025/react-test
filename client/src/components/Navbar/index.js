            ...
            <NavBar >
                ...
                <NavbarContainer>
                    ...
                    <NavMenu>
                        ...
                        <NavLinks to='lists' smooth={true} duration={500} spy={true} exact='true' offset={-80}><GiShoppingCart /></NavLinks>
                        <NavLinks to='User' smooth={true} duration={500} spy={true} exact='true' offset={-80}><MdPersonOutline /></NavLinks>
